import gin
from goal_builders import bfs_goal_builder_sokoban
from goal_builders import bfs_goal_builder_sokoban_pixel_diff
...
TrivialGoalBuilderSokoban = configure_goal_builder(bfs_goal_builder_sokoban.TrivialGoalBuilderSokoban)
